    ...
    >
      <div className='h-full max-h-[100vh] md:pt-20 flex-1 flex flex-col items-center text-left lg:items-center lg:justify-start mb-2'>
        ...
        <section className='mb-5 md:mb-12 flex flex-col gap-2'>
          ...
          <div>
            <button onClick={() => setOption('myReservs')} className='bg-primary rounded px-2 text-secundary py-2 text-lg md:text-xl font-medium w-full'>Ir para o menu de reservas</button>
          </div>
        </section>

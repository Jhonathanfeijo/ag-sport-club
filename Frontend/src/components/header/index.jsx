...
const Header = () => {
    ...
    return (
        <>
            ...
            <header className="max-w-full absolute top-0 left-0 px-3 py-2 flex lg:w-56 lg:flex lg:max-w-[25%] w-full lg:h-screen bg-principal lg:flex-col items-center lg:items-start text-xl justify-between">

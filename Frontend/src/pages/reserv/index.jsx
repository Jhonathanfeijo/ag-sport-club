...
const Reserv = () => {
    ...
    return (<>
        ...
        {isModalCreateOpen === true ? (
            <div className='bg-third bg-opacity-10 flex flex-col flex-wrap justify-center items-center opacity-100 fixed top-0 left-0 w-screen h-screen'>
                <div className="h-[80%] md:w-[450px] w-[85%] bg-secundary rounded-md shadow-xl drop-shadow-xl duration-500 ">
